...
export function createUmi(endpoint: string, rpcOptions?: Web3JsRpcOptions & ChunkGetAccountsRpcOptions): Umi
export function createUmi(connection: Web3JsConnection, rpcOptions?: ChunkGetAccountsRpcOptions): Umi
