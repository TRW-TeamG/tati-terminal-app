...
export function defaultPlugins(endpoint: string, rpcOptions?: Web3JsRpcOptions & ChunkGetAccountsRpcOptions): UmiPlugin
export function defaultPlugins(connection: Web3JsConnection, rpcOptions?: ChunkGetAccountsRpcOptions): UmiPlugin
